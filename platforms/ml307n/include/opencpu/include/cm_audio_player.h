...
typedef enum
{
    ...
    CM_AUDIO_PLAY_DRIVER_PWM,                       /*!< PWM输出方案 暂不支持*/
...
typedef enum
{
    CM_AUDIO_PLAY_CNTX_FILE = 0,           /*!< 文件播放*/
    CM_AUDIO_PLAY_CNTX_STREAM,              /*!<流播放*/
} cm_audio_play_cntx_e;
 ...
 *  @brief 设置播放输出方案
 *
 *  @param [in] driver_type  支持CODEC/DAC
 *
 */
