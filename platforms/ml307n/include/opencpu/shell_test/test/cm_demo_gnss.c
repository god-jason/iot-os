...
static void SHELL_gnss(char argc, char **argv)
{
    ...
    {
        shell_printf("cm_gnss <sub_cmd> <arg1> <arg2> ...\r\n");
        shell_printf("1 cm_gnss gnss_enable arg1 arg2 arg3\r\n");
        shell_printf("  [arg1:1-open GNSS,0-close GNSS][arg2:gnss type(cm_gnss_type_e)][arg3:1-close agnss,2-open agnss]\r\n");
