 ...
 * @{
 *
 * @note 该头文件是基于cm_iomux_v2.h扩充版，产品定义（管脚映射关系）对应sdk/doc/ML307N-OC产品定义.xlsx。
 *
 *
 */
/**********************************************************************************
...
#define pin_res pin_res_v1
extern const struct PIN_Res* pin_res[CM_IOMUX_PIN_MAX];

#define cm_iomux_set_pin_func cm_iomux_set_pin_func_v1
#define cm_iomux_get_pin_func cm_iomux_get_pin_func_v1
#define cm_iomux_set_pin_cmd cm_iomux_set_pin_cmd_v1
 ...
 *    = 0  - 成功 \n
 *    = -1 - 失败
 * @deprecated 不建议使用，该接口仅用于老版本兼容，推荐使用cm_iomux_set_pin_func_v2
 */
int32_t cm_iomux_set_pin_func_v1(cm_iomux_pin_e pin, cm_iomux_func_e fun);
 ...
 *    = 0  - 成功\n
 *    < 0  - 失败
 * @deprecated 不建议使用，该接口仅用于老版本兼容，推荐使用cm_iomux_get_pin_func_v2
 */
int32_t cm_iomux_get_pin_func_v1(cm_iomux_pin_e pin, cm_iomux_func_e *fun);
 ...
 *    = 0  - 成功\n
 *    < 0  - 失败
 * @deprecated 不建议使用，该接口仅用于老版本兼容，推荐使用cm_iomux_set_pin_cmd_v2
 */
int32_t cm_iomux_set_pin_cmd_v1(cm_iomux_pin_e pin, cm_iomux_pincmd_e cmd, uint8_t cmd_arg);
