...
typedef enum{
    CM_PWM_DEV_0,              /*!< 设备0（绑定CM_IOMUX_PIN_74）*/
    CM_PWM_DEV_1,              /*!< 设备1（绑定CM_IOMUX_PIN_79）*/
    CM_PWM_DEV_2,              /*!< 设备2（绑定CM_IOMUX_PIN_75）*/
    CM_PWM_DEV_3,              /*!< 设备3（绑定CM_IOMUX_PIN_57）*/
    CM_PWM_DEV_NUM
} cm_pwm_dev_e;
...
*  @details : 该接口 暂不支持 PWM直接 将引脚复用后 直接open即可产生波形
* 只支持32k的时钟，不支持选择12.8M
*/
