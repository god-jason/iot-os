...
/**
 * @brief 创建任务（线程）
 * @param name 任务名称（Linux 不使用）
 * @param func 任务函数
 * @param arg 传递给任务的参数
 * @param stack_size 栈大小（字节），0 表示使用默认大小
 * @param priority 任务优先级（Linux 不使用）
...
/* Socket 错误码映射 */
/** 操作将阻塞 */
#define IOT_EAGAIN                EAGAIN
/** 操作将阻塞 */
#define IOT_EWOULDBLOCK           EWOULDBLOCK
/** 操作正在进行中 */
#define IOT_EINPROGRESS           EINPROGRESS
/** 操作已在进行中 */
#define IOT_EALREADY              EALREADY
/** 参数不是 Socket */
#define IOT_ENOTSOCK              ENOTSOCK
/** 缺少目标地址 */
#define IOT_EDESTADDRREQ          EDESTADDRREQ
/** 消息过长 */
#define IOT_EMSGSIZE              EMSGSIZE
/** 协议类型错误 */
#define IOT_EPROTOTYPE            EPROTOTYPE
/** 协议选项不支持 */
#define IOT_ENOPROTOOPT           ENOPROTOOPT
/** 协议不支持 */
#define IOT_EPROTONOSUPPORT       EPROTONOSUPPORT
/** Socket 类型不支持 */
#define IOT_ESOCKTNOSUPPORT       ESOCKTNOSUPPORT
/** 操作不支持 */
#define IOT_EOPNOTSUPP            EOPNOTSUPP
/** 协议族不支持 */
#define IOT_EPFNOSUPPORT          EPFNOSUPPORT
/** 地址族不支持 */
#define IOT_EAFNOSUPPORT          EAFNOSUPPORT
/** 地址已在使用 */
#define IOT_EADDRINUSE            EADDRINUSE
/** 地址不可用 */
#define IOT_EADDRNOTAVAIL         EADDRNOTAVAIL
/** 网络已断开 */
#define IOT_ENETDOWN              ENETDOWN
/** 网络不可达 */
#define IOT_ENETUNREACH           ENETUNREACH
/** 网络重置 */
#define IOT_ENETRESET             ENETRESET
/** 连接中止 */
#define IOT_ECONNABORTED          ECONNABORTED
/** 连接被重置 */
#define IOT_ECONNRESET            ECONNRESET
/** 缓冲区不足 */
#define IOT_ENOBUFS               ENOBUFS
/** 已连接 */
#define IOT_EISCONN               EISCONN
/** 未连接 */
#define IOT_ENOTCONN              ENOTCONN
/** Socket 已关闭 */
#define IOT_ESHUTDOWN             ESHUTDOWN
/** 连接超时 */
#define IOT_ETIMEDOUT             ETIMEDOUT
/** 连接被拒绝 */
#define IOT_ECONNREFUSED          ECONNREFUSED
/** 主机已关闭 */
#define IOT_EHOSTDOWN             EHOSTDOWN
/** 主机不可达 */
#define IOT_EHOSTUNREACH          EHOSTUNREACH
/** 网络不存在 */
