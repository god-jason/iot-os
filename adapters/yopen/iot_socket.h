/**
 * @file iot_socket.h
 * @brief YOPEN 平台 Socket 适配器头文件
 * @details 基于 lwip 库实现统一的 Socket 接口封装，
 *          支持 TCP/UDP Socket 的同步操作，提供标准的 BSD-like 接口。
 */

#ifndef IOT_SOCKET_YOPEN_H
#define IOT_SOCKET_YOPEN_H
 ...
 * @return 0 成功，<0 失败
 */
iot_err_t iot_socket_close(iot_socket_t sock);
 ...
 */
iot_err_t iot_socket_connect(iot_socket_t sock, const iot_socket_addr_t *addr);
 ...
 * @return 0 成功，<0 失败
 */
iot_err_t iot_socket_bind(iot_socket_t sock, const iot_socket_addr_t *addr);
 ...
 * @return 0 成功，<0 失败
 */
iot_err_t iot_socket_listen(iot_socket_t sock, int backlog);
 ...
 * @return 0 成功，<0 失败
 */
iot_err_t iot_socket_shutdown(iot_socket_t sock, int how);
 ...
 * @return 0 成功，<0 失败
 */
iot_err_t iot_socket_get_local_addr(iot_socket_t sock, iot_socket_addr_t *addr);
 ...
 * @return 0 成功，<0 失败
 */
iot_err_t iot_socket_get_peer_addr(iot_socket_t sock, iot_socket_addr_t *addr);
 ...
 * @return 0 成功，<0 失败
 */
iot_err_t iot_socket_setsockopt(iot_socket_t sock, int level, int optname,
 ...
 * @return 0 成功，<0 失败
 */
iot_err_t iot_socket_getsockopt(iot_socket_t sock, int level, int optname,
 ...
 * @return 0 成功，<0 失败
 */
iot_err_t iot_socket_select(iot_socket_t *reads, int read_count,
 ...
 * @return 0 成功，<0 失败
 */
iot_err_t iot_socket_get_host_by_name(const char *hostname, uint32_t *ipaddr);
