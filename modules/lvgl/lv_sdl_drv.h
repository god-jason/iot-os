 ...
 *
 * 使用方式：
 *   iot_lv_sdl_drv_init();          // 初始化 SDL 窗口与 LVGL 显示/输入驱动
 *   iot_lv_sdl_drv_loop();          // 在主循环中调用（处理事件 + lv_task_handler）
 *   iot_lv_sdl_drv_deinit();        // 清理资源
 *
 * @author  TRAE
 * @date    2026.07.30
 */

#ifndef IOT_LV_SDL_DRV_H
#define IOT_LV_SDL_DRV_H
