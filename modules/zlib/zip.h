...
/* ZIP错误码定义 */
#define IOT_ZIP_OK              0   /**< 成功 */
#define IOT_ZIP_ERR_MEM        -1   /**< 内存分配失败 */
#define IOT_ZIP_ERR_FORMAT     -2   /**< ZIP格式错误 */
#define IOT_ZIP_ERR_CRC        -3   /**< CRC校验失败 */
#define IOT_ZIP_ERR_FILE       -4   /**< 文件操作失败 */
#define IOT_ZIP_ERR_NOT_FOUND  -5   /**< 条目未找到 */
 ...
 * 存储ZIP文件中单个文件/目录的信息。
 */
typedef struct iot_zip_entry_t iot_zip_entry_t;
struct iot_zip_entry_t {
 ...
 */
typedef struct iot_zip_t iot_zip_t;
struct iot_zip_t {
    void *fd;                   /**< 文件句柄 */
    size_t size;                /**< ZIP文件总大小 */
    iot_zip_entry_t *entries;       /**< 条目数组 */
