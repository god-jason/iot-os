...
/* TAR错误码定义 */
#define IOT_TAR_OK              0   /**< 成功 */
#define IOT_TAR_ERR_MEM        -1   /**< 内存分配失败 */
#define IOT_TAR_ERR_FORMAT     -2   /**< TAR格式错误 */
#define IOT_TAR_ERR_FILE       -3   /**< 文件操作失败 */
#define IOT_TAR_ERR_NOT_FOUND  -4   /**< 条目未找到 */

/* TAR压缩级别定义 */
#define IOT_TAR_COMPRESS_FAST    1   /**< 快速压缩 */
#define IOT_TAR_COMPRESS_DEFAULT 6   /**< 默认压缩 */
#define IOT_TAR_COMPRESS_BEST   9   /**< 最佳压缩 */
 ...
 * 存储TAR文件中单个文件/目录的信息。
 */
typedef struct iot_tar_entry_t iot_tar_entry_t;
struct iot_tar_entry_t {
 ...
 * 维护TAR文件的上下文信息。
 */
typedef struct iot_tar_t iot_tar_t;
struct iot_tar_t {
    void *fd;           /**< 文件句柄 */
    iot_tar_entry_t *entries;   /**< 条目数组 */
