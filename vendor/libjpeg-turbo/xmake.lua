...
target("libjpeg-turbo")
    ...
    add_files("src/jccoefct.c", "src/jccolor.c", "src/jcdctmgr.c")
    ...
    add_files("src/jdcoefct.c", "src/jdcolor.c")
    ...
    add_files("src/jdmarker.c", "src/jdmaster.c", "src/jdmerge.c")
    add_files("src/jdphuff.c", "src/jdpostct.c", "src/jdsample.c")
    ...
    add_files("src/jquant2.c", "src/jutils.c")
    add_headerfiles("src/jpeglib.h", "src/jerror.h", "src/jmorecfg.h", "src/jpegint.h")

    -- jconfig.h / jconfigint.h / jversion.h (normally generated by CMake)
    add_includedirs(path.join(os.scriptdir(), "build/config"), {public = true})
    add_includedirs("src")
