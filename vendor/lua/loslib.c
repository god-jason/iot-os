...
/*
** @brief 执行系统命令（已禁用，嵌入式系统不支持）
*/
#if defined(LUA_USE_EMBEDDED_DISABLE_OS_EXECUTE)
...
/*
** @brief 临时文件名（已禁用，嵌入式系统不支持）
*/
#if defined(LUA_USE_EMBEDDED_DISABLE_OS_TMPNAME)
static int os_tmpname (lua_State *L) {
  (void)L;
  return luaL_error(L, "os.tmpname is not supported on this platform");
}
#else
static int os_tmpname (lua_State *L) {
